...
const Home: NextPage = () => {
  ...
  const myLoader = ({ src, width, quality }: any) => {
    return `https://avatars.githubusercontent.com/u/65522153?v=4`;
  };
        ...
        <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
          ...
          >
            <div className="p-4 md:p-12 text-center lg:text-left">
              <div className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center bg-[url('https://avatars.githubusercontent.com/u/65522153?v=4')]"></div>
