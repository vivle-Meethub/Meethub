...
<div
        ...
        style={{display:'absolute', width: '100%', height: '100%',top: 0, left: 0, overflow: 'hidden', touchAction: 'none'}}

      >
        <video style={{ width: '100%', height:'100vh',objectFit:'cover' }} muted autoPlay loop>
            ...
            <div className="leading-loose">
                <form className="max-w-sm p-10 m-auto bg-white bg-opacity-25 rounded shadow-xl">
                    ...
                    <div className="mb-2">
                        ...
                        <div className="mb-2">
                            <div className=" relative ">
                            <button type="button" className="py-2 px-4 flex justify-center items-center  bg-[#03C75AB3] hover:bg-[#03C75A] focus:ring-[#03C75AB3] focus:ring-offset-gray-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                            ...
                            <div className="text-center">
                                <span className="text-white font-bold right-0 inline-block text-sm align-baseline">
                                밋허브에서 누가 얼마나 <br /> 허슬하고 있는지 확인해보세요!
                                </span>
                            </div>
                        </form>
                    </div>
