...
const Home: NextPage = () => {
  ...
  return (
    <Layout seoTitle="Main">
      ...
      <div
        className="jb-box"
        style={{ width: '100%', height: '100%', overflow: 'hidden', margin: '0px auto', position: 'relative' }}
      ...
      >
        ...
        <div
          className="jb-text"
          style={{ position: 'absolute', top: '35%', left:'35%', width: '50%', zIndex: 10, color: '#fff' }}

        >
        

          <div
          style={{ marginTop: '-24px', textAlign: 'center',  color: '#000' }}
            id="profile"
            className="w-full lg:w-3/5 shadow-2xl bg-white opacity-90"
          >
            <div className="p-4 md:p-12 text-center lg:text-left">
              <div className="block lg:hidden rounded-full  -mt-16 h-48 w-48 bg-cover bg-center bg-[url('https://avatars.githubusercontent.com/u/65522153?v=4')]"></div>

              <input
                className="focus:outline-none font-bold pt-8 lg:pt-0"
              ...
              <p className="font-bold pt-8 text-sm">
                밋허브에서 검색해서 누가 얼마나 <br /> 허슬하고 있는지 확인해
                보세요!
              </p>
              ...
              <div className="pt-12 pb-8">
                <button
                  ...
                  className="bg-[#b8e994] hover:bg-[#78e08f] text-white font-bold py-2 px-4 rounded-full"
                >
                  검색하기
                </button>
              </div>
              ...
              <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                ...
                >
                  <svg
                    className="h-6 fill-current text-gray-600 hover:text-[#78e08f]"
                    role="img"
                    viewBox="0 0 24 24"
